...
public class CountingAnimal extends Animal {
	...
	public void getCountofAnimalActivities() {
		...
		if (getBird().sing().equals("I am singing") || getDuck().getSound().equals("I am singing")
				...
				|| getFish().sing().equals("I am singing")
				|| getShark().sing().equals("I am singing") || getClown().sing().equals("I am singing")
				|| getDol().sing().equals("I am singing") || getDog().parrotSays().equals("I am singing")
				|| getButt().sound().equals("I am singing")) {
			sing++;
		}
